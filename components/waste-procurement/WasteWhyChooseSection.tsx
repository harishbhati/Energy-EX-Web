import { ShieldCheck, Globe2, Building2, LucideIcon } from 'lucide-react';

const cards: { Icon: LucideIcon; title: string; desc: string }[] = [
  {
    Icon: ShieldCheck,
    title: 'Independent Advice',
    desc: 'We work on behalf of our clients, not waste contractors.',
  },
  {
    Icon: Globe2,
    title: 'Extensive Supplier Network',
    desc: 'Access to licensed waste providers across the UK, covering a wide range of streams and industries.',
  },
  {
    Icon: Building2,
    title: 'Multi-Site Specialists',
    desc: 'Managing waste services across complex property and operational portfolios, with one point of contact.',
  },
];

export default function WasteWhyChooseSection() {
  return (
      ...
      <div className="max-w-[1180px] mx-auto">
        <div className="text-center mb-8">
          <p className="text-[11px] font-bold text-brand-orange uppercase tracking-[2.5px] mb-[14px]">
            Why choose Energyex for waste
          </p>
          <h2 className="font-serif-num text-[32px] font-semibold text-ink tracking-[-0.5px] leading-[1.12] mb-4">
            Independent advice that continues after the contract.
          </h2>
          <p className="text-[17px] text-muted leading-[1.7] font-light max-w-[680px] mx-auto">
            We work on behalf of our clients, not waste contractors — with support that runs throughout the
            contract lifecycle.
          </p>
        </div>
