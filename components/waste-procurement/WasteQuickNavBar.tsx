...
import { AlertTriangle, RefreshCw, Recycle, FileText, ShieldCheck, LucideIcon } from 'lucide-react';

const navItems: { id: string; Icon: LucideIcon; label: string }[] = [
  { id: 'issues', Icon: AlertTriangle, label: 'Common Issues' },
  { id: 'process', Icon: RefreshCw, label: 'Our Process' },
  { id: 'services', Icon: Recycle, label: 'Waste Services' },
  { id: 'compliance', Icon: FileText, label: 'Compliance' },
  { id: 'why', Icon: ShieldCheck, label: 'Why Energyex' },
];

export default function WasteQuickNavBar() {
  const [hovered, setHovered] = useState<string | null>(null);

  return (
    <nav
      aria-label="Waste procurement sections"
