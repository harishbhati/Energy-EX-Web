...
import { Droplets, Recycle, Building2, Sparkles, LucideIcon } from 'lucide-react';

const links: { label: string; Icon: LucideIcon; href: string }[] = [
  { label: 'Water', Icon: Droplets, href: '#water' },
  { label: 'Waste', Icon: Recycle, href: '#waste' },
  { label: 'Property', Icon: Building2, href: '#property' },
  { label: 'Cleaning', Icon: Sparkles, href: '#cleaning' },
];

export default function FacilityQuickNavBar() {
